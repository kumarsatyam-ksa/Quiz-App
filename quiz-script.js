...
const signUpToSignInBtn = document.getElementById('signUpToSignIn');
...
signUpToSignInBtn.addEventListener('click', (event) => {
...
function showResultBox(){
    ...
    if(userScore < 5){
        let scoreTag = '<span>Sorry, you scored only <p>' + userScore + '</p> out of <p>' + questions.length + '</p> marks!</span>';
        scoreText.innerHTML = scoreTag;
    }
    else if((userScore > 4) && (userScore < 8)){
        let scoreTag = '<span>You scored <p>' + userScore + '</p> out of <p>' + questions.length + '</p> marks!</span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span>Congrats, you scored <p>' + userScore + '</p> out of <p>' + questions.length + '</p> marks!</span>';
        scoreText.innerHTML = scoreTag;
    }
}
